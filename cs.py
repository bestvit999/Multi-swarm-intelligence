...
if os.path.exists('results/{}-{}'.format(test_fn, dimension)):
    result = open('results/{}-{}/avg-of-{}-trial.txt'.format(test_fn, dimension, trials), 'w+')
else:
    os.makedirs('results/{}-{}'.format(test_fn, dimension))
    result = open('results/{}-{}/avg-of-{}-trial.txt'.format(test_fn, dimension, trials), 'w+')
